  ...
  Object.defineProperty(obj, key, {
    ...
    get: function reactiveGetter () {
      ...
      if (Dep.target) {
        ...
        //在单一Vue实例中，Watcher与Dep之间，是一对多的关系
        //但考虑到Vue实例内部存在嵌套（或者用户手写了watch表达式），那么Dep中也会保存多个Watcher（保存在subs数组中）
        //这样，当key发生变化时，对应的Watcher的notify()方法就会被触发，对应的Vue实例就会更新
        dep.depend()
        if (childOb) {
          childOb.dep.depend()
          if (Array.isArray(value)) {
